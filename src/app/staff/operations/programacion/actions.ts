...
const raw = (form: FormData) => ({ code: value(form, "code"), autoGenerateCode: value(form, "autoGenerateCode"), name: value(form, "name"), routeId: value(form, "routeId"), daysOfWeek: form.getAll("daysOfWeek").map(Number), departureTimeMinutesUtc: Number(value(form, "departureTimeMinutesUtc")), scheduledDurationMinutes: Number(value(form, "scheduledDurationMinutes")), eligibleFleetIds: form.getAll("eligibleFleetIds").map(String), effectiveFrom: value(form, "effectiveFrom"), effectiveUntil: value(form, "effectiveUntil"), bookingOpenOffsetMinutes: Number(value(form, "bookingOpenOffsetMinutes")), bookingCloseOffsetMinutes: Number(value(form, "bookingCloseOffsetMinutes")), generationHorizonDays: Number(value(form, "generationHorizonDays")), notes: value(form, "notes") });
