...
const negativeCredits = (cents: number) => cents === 0 ? credits(0) : `−${credits(Math.abs(cents))}`;
        ...
        : <DataTable
          ...
          rows={payroll.map((record) => {
            ...
            return [
              ...
              <span key="penalty" className={record.penaltyCents ? "amount-negative" : ""}>{negativeCredits(record.penaltyCents)}</span>,
                ...
                <details className="calculation-details">
                  ...
                  <div className="calculation-panel">
                    <div className="calculation-grid">
                      ...
                      <span>Penalizaciones <strong>{negativeCredits(record.penaltyCents)}</strong></span>
