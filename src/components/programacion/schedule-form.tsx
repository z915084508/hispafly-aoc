...
export function ScheduleForm({
  ...
  const [fleetId, setFleetId] = useState(value.defaultFleetId ?? "");
  ...
  }, [allowReturnCreation, routeId, routes]);
  ...
  const validate = async () => {
    ...
    try {
      ...
      const assignedAircraftId = (document.querySelector('[name="assignedAircraftId"]') as HTMLSelectElement | null)?.value || null;
