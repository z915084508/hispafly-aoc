...
const flightNavItems = [
  ["dashboard", "/pilot/dashboard"], ["pireps", "/pilot/pireps"], ["offers", "/pilot/flight-offers"], ["bookings", "/pilot/bookings"], ["ofp", "/pilot/flight-offers"], ["fleet", "/pilot/fleet"], ["roster", "/pilot/roster"],
] as const;
