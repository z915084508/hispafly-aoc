...
export function Identity({ primary, secondary }: { primary: string; secondary?: string | null }) {
  return <span className="primary">{primary}{secondary && <span className="secondary">{secondary}</span>}</span>;
}
