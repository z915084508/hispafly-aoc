...
const navItems = [
  ["dashboard", "/staff"], ["pilots", "/staff/pilots"], ["fleet", "/staff/fleet"], ["fleets", "/staff/fleets"], ["aircraft", "/staff/aircraft"], ["performance", "/staff/fleet-performance"], ["routes", "/staff/routes"], ["pireps", "/staff/pireps"], ["offers", "/staff/flight-offers"], ["ofp", "/staff/ofp"], ["fuelPolicy", "/staff/fuel-policy"],
