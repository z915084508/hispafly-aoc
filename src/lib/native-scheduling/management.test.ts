...
assert.doesNotMatch(codeGeneration, /route\.flightNumber/, "schedule codes derive from the route code, not a route-owned flight identity");
...
assert.match(form, /Automático: usa el código de ruta/);
assert.match(management, /allocateScheduleIdentities/, "Programación allocates the flight identity");
