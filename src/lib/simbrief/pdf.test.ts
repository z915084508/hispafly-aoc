...
assert.equal(extractSimbriefPdfUrl({ files: { directory: "https://www.simbrief.com/ofp/flightplans", pdf: { link: "LEMDLEVC_PDF_1783244128.pdf" } } }), "https://www.simbrief.com/ofp/flightplans/LEMDLEVC_PDF_1783244128.pdf");
console.log("SimBrief PDF URL: 7 assertions passed.");
