...
export function validateRouteForm(form: FormData): RouteFormInput {
  ...
  return { localId: text(form, "id") || undefined, type: text(form, "type") || "scheduled", callsign, flightNumber, departureIcao, arrivalIcao, departureTime: text(form, "departureTime") || undefined, arrivalTime: text(form, "arrivalTime") || undefined, durationMinutes: optionalInt(form, "durationMinutes"), distanceNm: optionalInt(form, "distanceNm"), altitude: optionalInt(form, "altitude"), costIndex: text(form, "costIndex") || undefined, route: text(form, "route") || undefined, hidden: form.get("hidden") === "on", remarks: text(form, "remarks") || undefined, internalNotes: text(form, "internalNotes") || undefined, fleetIds };
}
